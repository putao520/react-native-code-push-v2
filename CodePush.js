import { AcquisitionManager as Sdk } from "code-push-v2/script/acquisition-sdk";
...
async function checkForUpdate(deploymentKey = null, handleBinaryVersionMismatchCallback = null, extraInfo = {}) {
  /*
...
async function syncInternal(options = {}, syncStatusChangeCallback, downloadProgressCallback, handleBinaryVersionMismatchCallback) {
  ...
  try {
    ...
    const remotePackage = await checkForUpdate(syncOptions.deploymentKey, handleBinaryVersionMismatchCallback, syncOptions.extraInfo);
